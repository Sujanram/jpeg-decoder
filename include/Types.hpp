...
namespace kpeg
{
    ...
    /// The channels we deal with here are Red, Green and Blue channels in the RGB color model  and the Y, Cb and Cr channels in the Y-Cb-Cr color model.
    ...
    struct Pixel
    {
        ...
        // comp1 ,comp2 ,comp3- Intensity value of pixel component 1, component 2 ,component 3
    ...
    /// E.g., To access the Huffman table for the DC coefficients of the CbCr component, we use `huff_table[HT_DC][HT_CbCr]`.
    const int HT_DC   = 0;
    const int HT_AC   = 1;
    const int HT_Y    = 0;
    const int HT_CbCr = 1;
